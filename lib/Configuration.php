...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://eu-access-admin-int-host:14222/eu-access/admin-int/usersData';
    ...
    {
        $report  = 'PHP SDK (EC\EUAccess\Client) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://eu-access-admin-int-host:14222/eu-access/admin-int/usersData",
                "description" => "EU Access Users API endpoint (docker)",
            ]
        ];
    }
